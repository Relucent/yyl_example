...
public class SqrtxTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sqrt(Integer.MAX_VALUE/* 2147483647 */));// 46340.95
        System.out.println(sqrt(Long.MAX_VALUE/* 9223372036854775807 */));// 3037000499.98
    }
     ...
     * 当被开方数为 Integer.MAX_VALUE(2147483647) 时迭代次数仅为20次。<br>
     * 当被开方数为 Long.MAX_VALUE (9223372036854775807) 时迭代次数仅为36次。<br>
