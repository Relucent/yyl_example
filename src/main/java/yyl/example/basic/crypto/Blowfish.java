...
public class Blowfish {
	...
	private static class BlowfishECB {
		...
		public static boolean selfTest() {
			...
			byte[] testKey1 = { (byte) 0x1c, (byte) 0x58, (byte) 0x7f, (byte) 0x1c, (byte) 0x13, (byte) 0x92, (byte) 0x4f,
					(byte) 0xef };
	 ...
	 * @param nSrcPos from which character in the string the conversion should begin, remember that (nSrcPos modulo 2)
	 *        should equals 0 normally
